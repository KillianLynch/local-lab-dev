...
This workshop lets you try out some of the new features in Oracle Database 19c. 

* Application Development
    - JSON
* Availability & Performance 
    - Long identifiers / online table move
    - ADG automatic redirect
* Security & Analytics
...
* **Contributors** - Many thanks to those who helped make this
